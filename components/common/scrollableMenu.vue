<template>
    <div class="overflow-x-auto py-0 whitespace-nowrap">
      <div class="flex space-x-8 justify-center bg-gradient-to-r from-green-500 via-green-900 to-green-500 p-4 ">
        <div
        ...
        >
          <a
            href="#"
            :class="{
              'text-white bg-green-600 p-4 rounded-2xl': item.isActive,
